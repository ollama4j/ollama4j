...
class OllamaAPIIntegrationTest {
    ...
    //     * Ollama endpoint.
    //     *
    //     * <p>Scenario: Ensures the API client fails gracefully when the Ollama server is
    // unreachable.
    //     */
    //    @Test
    //    @Order(1)
    ...
    //     *
    //     * <p>Scenario: Pulls an embedding model, then checks that it is present in the list of
    // models.
    //     */
    //    @Test
    //    @Order(3)
    ...
    //     *
    //     * <p>Scenario: Pulls a model and retrieves its details, asserting the model file contains
    // the
    //     * model name.
    //     */
    //    @Test
    ...
    //     *
    //     * <p>Scenario: Uses the embedding model to generate vector embeddings for two input
    // sentences.
    //     */
    //    @Test
    //    @Order(5)
    ...
    //     *
    //     * <p>Scenario: Calls generateWithFormat with a prompt and a JSON schema, expecting a
    // structured
    ...
    //     *
    //     * <p>Scenario: Calls generate with a general-purpose model, streaming the response
    // tokens.
    ...
    //     *
    //     * <p>Scenario: Builds a chat request with system and user messages, sets a custom
    // temperature,
    ...
    //     *
    //     * <p>Scenario: Sends a system prompt instructing the assistant to reply with a specific
    // word,
    ...
    //     *
    //     * <p>Scenario: Sends a sequence of user messages, each time including the chat history,
    // and
    ...
    //     *
    //     * <p>Scenario: Registers a tool, sends a user message that triggers a tool call, and
    // verifies
    ...
    //        assertFalse(
    //                function.getArguments().isEmpty(), "Tool function arguments should not be
    // empty");
    ...
    //        assertEquals("Rahul Kumar", employeeName, "Employee name argument should be 'Rahul
    // Kumar'");
    //        assertTrue(
    //                chatResult.getChatHistory().size() > 2,
    ...
    //            }
    //        }
    //        assertTrue(toolCalled, "Assistant message should contain tool calls when useTools is
    // true");
    //    }
    //
    //    /**
    ...
    //     *
    //     * <p>Scenario: Registers a tool, sends a user message, and streams the assistant's
    // response
    ...
    //     *
    //     * <p>Scenario: Registers annotated tools, sends a user message that triggers a tool call,
    // and
    ...
    //     *
    //     * <p>Scenario: Registers annotated tools, sends a user message that may trigger a tool
    // call
    ...
    //     *
    //     * <p>Scenario: Sends a user message with thinking enabled and streams the assistant's
    // response.
    ...
    //     *
    //     * <p>Scenario: Sends a user message with an image URL and verifies the assistant's
    // response.
    ...
    //     *
    //     * <p>Scenario: Sends a user message with an image file, then continues the conversation
    // with
    ...
    //    //     *
    //    //     * <p>Scenario: Calls generateWithImages with a vision model and an image URL,
    // expecting a
    ...
    //     *
    //     * <p>Scenario: Calls generateWithImages with a vision model and an image file, expecting
    // a
    ...
    //     *
    //     * <p>Scenario: Calls generateWithImages with a vision model, an image file, and a
    // streaming
    ...
    //     *
    //     * <p>Scenario: Calls generate with think=true, expecting both response and thinking
    // fields to
    ...
    //    //     *
    //    //     * <p>Scenario: Calls generate with raw=true and think=true combination. Usage:
    // generate,
    ...
    //     *
    //     * <p>Scenario: Calls generate with all possible parameters enabled. Usage: generate,
    // raw=true,
    ...
    //     *
    //     * <p>Scenario: Enables thinking in chat mode without streaming. Usage: chat, thinking
    // enabled,
    ...
    //     *
    //     * <p>Scenario: Combines custom options (temperature, top_p, etc.) with streaming. Usage:
    // chat,
    ...
    //     *
    //     * <p>Scenario: The most complex chat scenario with all features enabled. Usage: chat,
    // tools,
    //     * thinking enabled, streaming enabled.
    //     */
    //    @Test
    ...
    //    //     *
    //    //     * <p>Scenario: Sends multiple image URLs to the vision model. Usage:
    // generateWithImages,
    ...
    //     *
    //     * <p>Scenario: Sends multiple images in one chat message. Usage: chat, vision model,
    // multiple
    ...
    //                OllamaChatRequestBuilder.builder().withModel(GENERAL_PURPOSE_MODEL);
    //        OllamaChatRequest requestModel =
    //                builder.withMessage(OllamaChatMessageRole.USER, "   ", tools) // whitespace
    // only
    //                        .build();
    //        requestModel.setUseTools(false);
    //        OllamaChatResult chatResult = api.chat(requestModel, null);
    ...
    //     *
    //     * <p>Scenario: Tests embedding generation with a single string instead of array. Usage:
    // embed,
    //     * single input.
    //     */
    //    @Test
    ...
    //     *
    //     * <p>Scenario: Tests the keep-alive parameter which controls model unloading. Usage:
    // chat,
    ...
    //     *
    //     * <p>Scenario: Tests generation with custom context length and other advanced options.
    // Usage:
    ...
    //     *
    //     * <p>Scenario: Sends multiple chat requests concurrently to test thread safety. Usage:
    // chat,
    ...
    //
    //        assertTrue(exceptions.isEmpty(), "No exceptions should occur during concurrent
    // requests");
    ...
    //     *
    //     * <p>This tool can be registered with the OllamaAPI to enable tool-calling scenarios in
    // chat.
    ...
    //                                                .description(
    //                                                        "Get details for a person or an
    // employee")
    //                                                .parameters(
    ...
    //                                        "Employee Details {ID: %s, Name: %s, Address: %s,
    // Phone:"
    //                                                + " %s}",
